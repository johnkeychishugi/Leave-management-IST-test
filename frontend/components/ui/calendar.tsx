    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-white text-gray-700 border border-gray-200 p-0 opacity-75 hover:opacity-100 hover:bg-gray-50"
        ),
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal text-gray-700 aria-selected:opacity-100 hover:bg-gray-100"
        ),
        day_range_end: "day-range-end",
        day_selected:
          "bg-indigo-600 text-white hover:bg-indigo-700 hover:text-white focus:bg-indigo-600 focus:text-white",
        day_today: "bg-gray-100 text-indigo-600 font-semibold",
        day_outside:
